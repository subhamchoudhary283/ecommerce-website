...
// exported through one object that is assets
export const assets = {
    logo,
    hero_img,
    cart_icon,
...
// this is array that name is products,  and this array have multiple objects, and each product representing  product id, name, description, price, image, category, subCategory, sizes, date, bestseller
export const products = [
    {
        _id: "aaaaa",
        name: "Women purple topwear",
    ...
    },
    {
        ...
        description: "A lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and short sleeves, worn as an undershirt or outer garment.",
        price: 200,
        image: [p_img2_1,p_img2_2,p_img2_3,p_img2_4],   // image array
        category: "Men",
        subCategory: "Topwear",
        sizes: ["M", "L", "XL"],
        date: 1716621345448,
